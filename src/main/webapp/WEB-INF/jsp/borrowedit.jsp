...
<body>
	...
	<div class="well lead">borrow editForm</div>
 	<form:form method="POST" modelAttribute="borrow" class="form-horizontal">
	...
	<%-- 	<div class="row">
		...
		<div class="row">
			<div class="form-actions floatRight">
				<c:choose>
					<c:when test="${edit}">
						<input type="submit" value="Update" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/borrowlist' />">Cancel</a>
					</c:when>
					<c:otherwise>
						<input type="submit" value="Register" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/borrowlist' />">Cancel</a>
					</c:otherwise>
				</c:choose>
			</div>
		</div> 
