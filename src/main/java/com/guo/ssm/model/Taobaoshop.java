...
public class Taobaoshop {
	...
	public Taobaoshop(String shop, String uRL, String iD, String totalSale, String tPrice, String name, String pic,
	...
	public String toString() {
		return "Taobaoshop [shop=" + shop + ", URL=" + URL + ", ID=" + ID + ", totalSale=" + totalSale + ", tPrice="
